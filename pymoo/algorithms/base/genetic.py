...
class GeneticAlgorithm(Algorithm):
    ...
    def __init__(self,
        ...
        if mating is None:
            #print('Mating not provided, need to do using mutation and crossover function ******************\n')
    ...
    def _initialize_infill(self):
        ...
        #print('intializing infil by filling pop using the do method of core.Initialization class *****************')
        return pop
